    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 my-auto" style="background:#fff; margin-top: 8em !important;">
          <h1 style="color:#000;margin-top: 1em;padding: 0;">Searched Posssbbbsst</h1>
          <?php  
            $query     = "SELECT * FROM `service` ORDER BY `day` DESC";
              ...
              <p class="card-text" style="font-size: 14px !important;">
                ...
                <?php 
                  ...
                  if ($check <= 0) { ?>
                     ...
                     <?php else: ?>
                      <a href="#" data-toggle="modal" data-target="#signup">Rate it</a>
                     <?php endif ?>
                  <?php } ?>
                </p>
                <!-- User Details -->
...
<script>
  function RateIT(val,serviceuserid,currentuserid)
  {
      data = {
        rating:val,
      ...
      $.post('rate.php', data, function(data, textStatus, xhr) {
        location.reload();
      });
  }
  function show(id)
